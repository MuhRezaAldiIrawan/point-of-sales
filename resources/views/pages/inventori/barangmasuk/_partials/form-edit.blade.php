                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="no_reff" name="no_reff"
                                            placeholder="" value="{{ $barangMasuk->no_reff }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class='input-group'>
                                            <input type='text' class="form-control" id="tanggal" name="tanggal"
                                                value="{{ $barangMasuk->tanggal_masuk->format('Y-m-d') }}" required>
                                            ...
                                            <select class="select2 form-control" id="jenis_stok_id" name="jenis_stok_id"
                                                ...
                                                @foreach ($jenisStoks as $jenisStok)
                                                    <option value="{{ $jenisStok->id }}"
                                                        {{ $barangMasuk->jenis_stok_id == $jenisStok->id ? 'selected' : '' }}>
                                                        {{ $jenisStok->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="catatan" name="catatan" rows="2" placeholder="Input Catatan...">{{ $barangMasuk->catatan }}</textarea>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    <script>
            ...
            if (editId) {
                ...
                if (itemIndex !== -1) {
                    ...
                    detailItems[itemIndex] = {
                        ...
                        isi: itemData.isi,
                        harga_beli: itemData.hargaBeli,
                        jumlah: itemData.jumlah,
                        total: itemData.hargaBeli * itemData.jumlah * itemData.isi,
        ...
        function validateItemData(data) {
            const validations = [{
                ...
                },
                {
                    ...
                    message: 'Masukkan harga beli yang valid (> 0)',
        ...
        function getTableRowsHTML() {
            ...
            return detailItems.map((item, index) => {
                ...
                <tr>
                    ...
                    <td class="text-right">${formatRupiah(item.harga_beli || 0)}</td>
        ...
        function handleFormSubmit(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Kirim data via AJAX
                    $.ajax({
                        url: $('#barangMasukEditForm').attr('action'),
                        method: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
        ...
        function toggleFormState(disabled = true) {
            ...
            if (disabled) {
                $('#barangMasukEditForm').addClass('form-disabled');
            } else {
                $('#barangMasukEditForm').removeClass('form-disabled');
            }
        }
