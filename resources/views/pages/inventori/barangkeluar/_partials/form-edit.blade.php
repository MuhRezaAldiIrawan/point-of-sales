...
@section('content')
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form id="barangKeluarEditForm" method="POST" action="{{ route('barangkeluar.update', $barangKeluar->id) }}">
                            @csrf
                            @method('PUT')
    ...
    <!-- Modal Tambah Jenis Stok -->
    <div class="modal fade" id="modalJenisStok" tabindex="-1" role="dialog" aria-labelledby="modalJenisStokLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
...
@section('js')
    <script>
        ...
        function toggleFormState(disabled = true) {
            const formElements = $('#barangKeluarEditForm input, #barangKeluarEditForm select, #barangKeluarEditForm button, #addItemBtn');
