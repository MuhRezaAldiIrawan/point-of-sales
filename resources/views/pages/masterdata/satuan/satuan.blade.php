...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <table class="table table-striped table-bordered" id="satuan-table">
                                <thead>
                                    <tr>
    ...
    @include('pages.masterdata.satuan._partials.form')
@endsection
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#formSatuan').on('submit', function(e) {
                ...
                var url = satuanId ? "/satuan/" + satuanId : "{{ route('satuan.store') }}";
                var method = satuanId ? "PUT" : "POST";
        ...
        $(document).on('click', '.btn-satuan-edit', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
        ...
        $(document).on('click', '.btn-satuan-delete', function(e) {
            e.preventDefault();
            let id = $(this).data('id');
