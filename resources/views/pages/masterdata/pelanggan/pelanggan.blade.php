...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <table class="table table-striped table-bordered" id="pelanggan-table">
                                <thead>
                                    <tr>
    ...
    @include('pages.masterdata.pelanggan._partials.form')
@endsection
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#pelanggan-table').DataTable({
                "processing": true,
                "serverSide": true,
            ...
            $('#formPelanggan').on('submit', function(e) {
                ...
                var url = pelangganId ? "/pelanggan/" + pelangganId : "{{ route('pelanggan.store') }}";
                var method = pelangganId ? "PUT" : "POST";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#pelanggan_id').val(''); // Reset ID setelah submit
                            table.ajax.reload();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#status_bayar').val(response.data.status_bayar);
                        $('#batas_kredit').val(response.data.batas_kredit);
