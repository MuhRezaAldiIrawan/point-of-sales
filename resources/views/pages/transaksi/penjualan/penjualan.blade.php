							...
							<div class="col-md-2">
								<div class="filter-group">
									...
									<div class="d-flex gap-2">
										<button type="button" id="applyFilter" class="btn btn-primary btn-filter btn-block">
			...
			<div class="card">
				<div class="card-header">
					...
					<div class="heading-elements">
                        <a href="{{ route('penjualan.create') }}" class="btn btn-primary btn-md d-flex align-items-center">
