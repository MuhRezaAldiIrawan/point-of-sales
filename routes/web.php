...
Route::middleware(['auth'])->group(function () {
    ...
    // ── Transaksi: Penjualan (Kasir, Administrator, Purchasing) ───────────────
    Route::middleware(['role:kasir,administrator,purchasing'])->group(function () {
    ...
    // ── Transaksi: Pembayaran (Kasir, Owner, Administrator, Purchasing) ───────
    Route::middleware(['role:kasir,owner,administrator,purchasing'])->group(function () {
    ...
    // ── Inventory (Administrator, Purchasing) ─────────────────────────────────
    ...
    // ── Inventory: Stok (Kasir, Administrator, Purchasing) ───────────────────
    Route::middleware(['role:kasir,administrator,purchasing'])->group(function () {
    ...
    // ── Master Data: Barang & Produk (Administrator, Purchasing) ─────────────
    Route::middleware(['role:administrator,purchasing'])->group(function () {
    ...
    // ── Master Data: Pelanggan (Administrator, Kasir, Purchasing) ────────────
    Route::middleware(['role:administrator,kasir,purchasing'])->group(function () {
    ...
    // ── Master Data: Bank (Administrator, HR, Purchasing) ────────────────────
    Route::middleware(['role:administrator,hr,purchasing'])->group(function () {
    ...
    // ── Master Data: Karyawan (Administrator, HR, Owner) ─────────────────────
    Route::middleware(['role:administrator,hr,owner'])->group(function () {
    ...
    // ── Master Data: Settings (Administrator, HR, Owner, Purchasing) ─────────
    Route::middleware(['role:administrator,hr,owner,purchasing'])->group(function () {
    ...
    // ── Laporan Penjualan (Administrator, Owner) ──────────────────────────────
    ...
    // ── Laporan Inventori (Administrator, Owner, Purchasing) ─────────────────
    Route::middleware(['role:administrator,owner,purchasing'])->group(function () {
